		...
		<div class="card shadow mb-4">
			<div class="card-header py-4 d-flex flex-row-reverse">
				<form enctype="multipart/form-data" id="fileUploadForm">
					<button id="btnAddCategory" style="width: 60px;" type="button"
					...
					<button style="width: 60px;" id="btnEditCategory" type="button"
					...
					<button style="width: 60px;" id="btnDeleteCategry" type="button"
						class="dt-button buttons-html5 btn btn-white btn-primary btn-bold"
						...
						<div class="modal-dialog modal-xl" role="document">
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="card shadow mb-4">
										...
										<div class="card-header py-3">
											<h6 class="m-0 font-weight-bold text-primary">Thêm thể loại
												</h6>
										</div>
										<div class="table">
											<div class="form-row">
												<div class="form-group col-md-6">
													<div class="row" style="padding-top: 20px;">
														<label style="padding-top: 6px; padding-left: 25px;"
															class="col-md-3" for="inputEmail4">Tên thể loại</label> <input
															name="nameCategory" type="text" class="col-md-7 form-control"
															id="nameCategory" placeholder="Tên sản phẩm">
													</div>
												</div>
									 ...
									 <div class="form-group col-md-6">
													<div class="row" style="padding-top: 20px;">
														<label style="padding-top: 6px; padding-left: 25px;"
															class="col-md-3" for="inputAddress">Thể Loại</label> <input
															name="codeCategory" type="text" class="col-md-7 form-control"
															id="codeCategory" placeholder="Thể Loại">
													</div>
													<div class="row" style="padding-top: 20px;">
								...
								<div class="modal-footer">
									...
									<button type="button" id="addCategory" class="btn btn-primary">Thêm
										thể loại</button>
									<button type="button" id="editCategory" class="btn btn-primary">Sửa
										thể loại</button>
								</div>
